    ...
    >
      ...
      <div className="section-container text-center relative z-10">
        <div className="animate-fade-in">
          <p className="text-primary text-lg mb-4 font-mono">Bună, sunt</p>
          <h1 className="mb-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
            Creez aplicații web moderne și scalabile folosind tehnologii de ultimă generație.
            Specializat în React, TypeScript și arhitecturi cloud-native.
          </p>
          <button
